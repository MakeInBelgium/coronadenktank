    ...
    <div className="row twelve columns">
      <div className="six columns">
        ...
        <ul>
          ...
          <li>Op <a href="http://klascement.net" target="_blanc">KlasCement.net</a> delen leraren als 20 jaar lesmateriaal en inspiratie. Ze bundelden nuttig materiaal en inspiratie voor leraren maar nu ook voor ouders op de homepage.<a href=""></a></li>
          <li>
