    ...
    <div className="row twelve columns">
      <div className="six columns">
        ...
        <ul>
          ...
          <li>Op <a href="http://klascement.net" target="_blank" rel="noopener noreferrer">KlasCement.net</a> delen leraren al 20 jaar lesmateriaal en inspiratie. Ze bundelden nuttig materiaal en inspiratie voor leraren maar nu ook voor ouders op de homepage.</li>
          <li>
